# Generated by Django 4.1.3 on 2022-12-26 01:19
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('tweets', '0005_remove_tweet_likes_count'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'index_together': {('user', 'created_at'), ('has_deleted', 'created_at'), ('status', 'created_at'), ('tweet', 'order')},
            },
        ),
    ]
